...
setup(
    ...
    description='Meetup API wrapper using tapioca',
    long_description=readme,
    author=get_author(package),
    author_email=get_email(package),
    url='https://github.com/lightstrike/tapioca-meetup',
    packages=[
        'tapioca_meetup',
    ],
    package_dir={'tapioca_meetup': 'tapioca_meetup'},
